...
commute_allowance = bart_kiosk(0,1,1,2)

def calculate_weekly_allowance(commute_allowance, fare_price):
	if (commute_allowance >= fare_price*10):
		print "Bart, and you're there!"
	else:
		print "Derp, you need more money."

print "testing calculate_weekly_allowance function"
print commute_allowance
print test_amt_1
calculate_weekly_allowance(commute_allowance, test_amt_1)
print commute_allowance
print test_amt_2
calculate_weekly_allowance(commute_allowance, test_amt_2)
